# Minecraft Server Controller v4.1

## 概要
ブラウザから操作可能な Minecraft サーバー管理ツールです。  
プレイヤー名ベースの認証、ホワイトリスト、OP管理、プラグイン管理、自動バックアップスケジューラーに対応しました。
README.mdの更新頻度は遅めです！
...
### 自動バックアップスケジューラー ⭐NEW
- **定期的な自動バックアップ**
  - cron形式でスケジュール設定（毎日、毎週、毎月など）
  - 複数のスケジュールを同時に運用可能
  
- **世代管理**
  - 古いバックアップを自動削除
  - 保持する世代数を設定可能（デフォルト7世代）
  
- **バックアップからのリストア**
  - ワンクリックでバックアップから復元
  - リストア前に現在のデータを自動バックアップ
